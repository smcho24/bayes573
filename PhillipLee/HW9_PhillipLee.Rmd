...
Does the forest fire within 1,500kmx1,500km of Bogota Columbia affect particulate matter readings? Do we observe higher PM readings for months in which forest fires were frequently observed?
...
```{r data import}
pm <- read_dta("/Users/philee/Downloads/bayes_final1.dta")
```
...
# 2. Run Stan
m1 <- stan(
    file = here("/Users/philee/Dropbox/USC/2022 Winter/Bayesian/Stan", "normal_2group.stan"),
    data = stan_dat,
...
The analysis showed that on average, months (Feb and March) with frequent forest fire showed higher PM concentrate than months that did not observe frequent forest fire, with a posterior mean of `r round(summ_m1$mean[5], 2)` and a 90% CI of [`r round(summ_m1$q5[5], 2)`, `r round(summ_m1$q95[5], 2)`].